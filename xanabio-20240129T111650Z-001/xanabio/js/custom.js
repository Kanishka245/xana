...
function navigateToSelectedSolution() {
    var selectedValue = document.getElementById("resourceSelector").value;
    if (selectedValue !== "#") {
      window.location.href = selectedValue;
    }
  }

  function navigateToSelectedDataset() {
    var selectedValue = document.getElementById("resourceSelector").value;
    if (selectedValue !== "#") {
      window.location.href = selectedValue;
    }
  ...
  function navigateToSelectedResource() {
    var selectedValue = document.getElementById("resourceSelector").value;
    if (selectedValue !== "#") {
      window.location.href = selectedValue;
    }
